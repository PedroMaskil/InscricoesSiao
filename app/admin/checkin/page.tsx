    ...
    <main style={{ minHeight: '100vh', background: '#13101f', fontFamily: 'Outfit, sans-serif', color: '#fff' }}>
      ...
      <div style={{ borderBottom: '1px solid rgba(255,255,255,0.07)', padding: '20px 28px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: 16 }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 20 }}>
          ...
          <div>
            <p style={{ fontSize: '0.72rem', letterSpacing: '0.2em', textTransform: 'uppercase', color: '#c084fc', marginBottom: 2 }}>Painel de Check-in</p>
            <h1 style={{ fontFamily: 'Cormorant Garamond, serif', fontSize: '1.6rem', fontWeight: 700, lineHeight: 1 }}>LightHouse 2026</h1>
          </div>
        </div>
        <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap' }}>
          <button onClick={() => { setScannerOpen(true); startScanner() }} style={{
            ...
            fontFamily: 'Outfit, sans-serif', boxShadow: '0 4px 20px rgba(124,58,237,0.35)',
          }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(160px, 1fr))', gap: 12, padding: '24px 28px 0' }}>
        {[
          { label: 'Caravanas',           value: `${caravansChecked} / ${caravans.length}`,    sub: 'fizeram check-in' },
          { label: 'Pessoas em caravana', value: totalPeople,                                   sub: 'total registrado' },
          { label: 'Individuais',         value: `${individualsChecked} / ${individuals.length}`, sub: 'fizeram check-in' },
        ].map(s => (
              ...
              <div key={i.id} style={{
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: 8, marginBottom: 3 }}>
                    ...
                    <span style={{ background: 'rgba(79,200,120,0.12)', borderRadius: 100, padding: '2px 10px', fontSize: '0.78rem', color: '#4fc878', fontWeight: 700, flexShrink: 0 }}>
                  ...
                  <div style={{ marginBottom: 16 }}>
                    ...
                    <div style={{ display: 'flex', gap: 8 }}>
                      {parseDays(scanResult.priceTier).map(d => (
                        <span key={d} style={{ background: 'rgba(192,132,252,0.15)', border: '1px solid rgba(192,132,252,0.4)', borderRadius: 8, padding: '6px 14px', fontSize: '0.85rem', color: '#e9d5ff', fontWeight: 700 }}>
                          {DAY_LABEL[d] ?? d}
                        </span>
                      ))}
                    </div>
